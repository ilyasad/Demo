    ...
    public function customerDatatableAction()
    {
    	...
    	if ($customers != null) {
    		foreach ( $customers as $c ) {
    			...
    			$tempTab [] = '<a href="/quizz_form/1/Dup/3" class="btn default green-stripe btn-sm hidden"> <i class="fa fa-edit"></i> Dupliquer </a><a href="" class="btn default green-stripe btn-sm"> <i class="fa fa-edit"></i> Editer </a>
    						<a href="' . $c->getRouting () . '/' . $c->getIdAdmin () . '" class="btn default blue-stripe btn-sm"> <i class="fa fa-sign-in"></i> Autologin </a>'; // fa-tags fa-superscript
